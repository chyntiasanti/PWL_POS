...
public function create()
    ...
    public function edit(string $id)
    {
        ...
        // Jika level tidak ditemukan, tampilkan pesan kesalahan
        if (!$level) {
    ...
    public function destroy(string $id)
    {
        ...
        try{
            ...
            return redirect('/level')->with('error', 'Data level tidak dapat dihapus karena masih terdapat data lain yang terkait dengan level ini');
        }    
    }
